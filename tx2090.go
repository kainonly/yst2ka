...
type Tx2090Dto struct {
	...
	ReceiverList    []Tx2090ReceiverList `json:"receiverList"`              // 收款人列表
...
func NewTx2090Dto(reqTraceNum string, receiverList []Tx2090ReceiverList) *Tx2090Dto {
	return &Tx2090Dto{
...
type Tx2090ReceiverList struct {
...
func NewTx2090ReceiverList(signNum string, amount int64) *Tx2090ReceiverList {
	return &Tx2090ReceiverList{
		SignNum: signNum,
		Amount:  amount,
	}
}

func (x *Tx2090ReceiverList) SetCouponAmount(v int64) *Tx2090ReceiverList {
	x.CouponAmount = v
	return x
}

func (x *Tx2090ReceiverList) SetSepDetail(v []Tx2090SepDetail) *Tx2090ReceiverList {
	x.SepDetail = v
	return x
}
