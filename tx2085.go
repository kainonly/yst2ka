...
func (x *Tx2085Dto) SetPayMode(v PayMode) *Tx2085Dto {
	x.PayMode = v
	return x
}
...
type Tx2085Result struct {
	...
	ReqTraceNum        string                   `json:"reqTraceNum"`                  // 商户订单号
	ExtendParams       string                   `json:"extendParams,omitempty"`       // 扩展参数
	ChannelParamInfo   Tx2085ChannelParamInfo   `json:"channelParamInfo,omitempty"`   // 渠道参数信息（支付详情）
	ChnlFrontParamInfo Tx2085ChnlFrontParamInfo `json:"chnlFrontParamInfo,omitempty"` // 渠道参数信息（前端支付参数）
